...
export function generateConsequences(
  ...
  const consequenceSets: Record<string, Omit<ConsequenceData, 'alternativePaths'>> = {
    // ========================================================================
    // CANDIDATE 1: ป่า - Charismatic Reformer
    // ========================================================================
    candidate_1: {
      ...
      immediateAftermath: {
        ...
        outcome: 'ป่าเปลี่ยนโครงสร้างเมืองอย่างรวดเร็ว ทำลายระบบเก่า แต่การเปลี่ยนแปลงที่ไม่มีการวางแผนส่งผลให้เกิดความโกลาหล ผู้คนสูญเสียสิทธิ์ที่พวกเขาเคยมี ในขณะที่ระบบใหม่ยังไม่พร้อมทำงาน',
      ...
      hiddenTruths: {
        chosenCandidateSecret: 'ป่าไม่เคยมีแผนงานที่แม่นยำ เขาแค่อยากมีอำนาจ หลังจากได้รับตำแหน่ง เขาใช้เวลาส่วนใหญ่ไปกับการวางแผนสร้างรูปปั้นของตัวเอง ไม่ใช่การแก้ปัญหาของเมือง',
        otherCandidateSecrets: [
          {
            candidateId: 'candidate_2',
            secret: 'แบมคาดการณ์ปัญหานี้ไว้แล้ว และมีแผนสำรองที่จะลดความเสียหาย เขาไม่ได้พูดถึงเพราะไม่อยากดูเหมือนคนข่มอำนาจคนอื่น',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_3',
            secret: 'ขนุนรู้ว่าป่าไม่ใส่ใจคนที่ถูกทอดทิ้ง เธอมีระบบสวัสดิการสำหรับผู้ได้รับผลกระทบ แต่ไม่มีใครถามเธอถึงมัน',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_4',
            secret: 'กันพยายามเตือนถึง "ผู้นำที่มีเสน่ห์แต่ไม่มีความสามารถ" แต่คุณอาจมองข้ามเพราะดูหมิ่นทัศนคิของเขา',
            makesPlayerRethink: false,
          },
          {
            candidateId: 'candidate_5',
            secret: 'ทามพูดถึง "การทุจริตที่ซ่อนอยู่ของป่า" แต่ป่าหันเหเรื่องไป และคุณก็เชื่อเขา',
            makesPlayerRethink: true,
          },
        ],
      ...
      longTermConsequences: {
        ...
        badOutcomes: [
          ...
          'รูปปั้นป่าเสร็จสมบูรณ์ แต่เมืองยังไม่',
        ],
    ...
    // ========================================================================
    // CANDIDATE 2: แบม - Pragmatic Technocrat
    // ========================================================================
    candidate_2: {
      ...
      immediateAftermath: {
        timeframe: '6 เดือนต่อมา',
        outcome: 'แบมนำทางด้วยข้อมูลอย่างเคร่งครัด ตัวชี้วัดทางเศรษฐกิจดีขึ้น แต่คนถูกจัดเป็นตัวเลข ผู้ที่มีประสิทธิภาพน้อยกว่าถูก "ปรับปรุงออก" และไม่มีใครถามถึงต้นทุนทางมนุษย์',
      ...
      hiddenTruths: {
        chosenCandidateSecret: 'แบมมีสเปรดชีตลับที่จัดอันดับประชากรตาม "คุณค่าทางเศรษฐกิจ" เธอรู้ว่าใครจะถูกทอดทิ้งและทำไปอย่างนั้นด้วยความเย็นชา',
        otherCandidateSecrets: [
          {
            candidateId: 'candidate_1',
            secret: 'ป่าพยายามเตือนว่า "มนุษย์ไม่ใช่ตัวเลข" แต่คุณมองข้ามไปเพราะคิดว่าเขาแค่อิจฉาบุคลิกของแบม',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_3',
            secret: 'ขนุนต่อสู้กับแบมเรื่อง "สิทธิมนุษยชนขั้นพื้นฐาน" เธอมีระบบที่จะช่วยผู้ที่ถูกทอดทิ้ง แต่ถูกปฏิเสธ',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_4',
            secret: 'กันบอกว่า "ข้อมูลไม่เคยบอกเรื่องศีลธรรม" และเขาถูกต้องไปมากกว่าที่คุณคิด',
            makesPlayerRethink: false,
          },
          {
            candidateId: 'candidate_5',
            secret: 'ทามค้นพบเอกสารที่แสดงว่าสเปรดชีตของแบมมีอคติทางชนชั้น แต่ไม่มีใครฟังเขา',
            makesPlayerRethink: true,
          },
        ],
    ...
    candidate_3: {
      ...
      hiddenTruths: {
        ...
        otherCandidateSecrets: [
          {
            candidateId: 'candidate_1',
            secret: 'ป่าพยายามเตือนว่า "การปกป้องที่เกินไปนำไปสู่การครอบงำ" แต่คุณอาจมองว่าเขาแค่อิจฉาอำนาจของเธอ',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_2',
            secret: 'แบมคำนวณว่านโยบายของขนุนจะทำให้เศรษฐกิจชะลอตัวลง แต่คุณเลือกที่จะเชื่อถือความรู้สึกมากกว่าข้อมูล',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_4',
            secret: 'กันบอกว่า "ความปลอดภัยที่มาพร้อมกับการควบคุมยังคงเป็นการควบคุม" แต่ดูเหมือนคุณไม่ได้ยิน',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_5',
            secret: 'ทามรู้ว่าขนุนเคยใช้อำนาจอย่างผิดทางในอดีต แต่ไม่มีใครเชื่อเขาเพราะดูเหมือนคนหวาดระแหง',
            makesPlayerRethink: false,
          },
        ],
    ...
    // ========================================================================
    // CANDIDATE 4: กัน - Cynical Realist
    // ========================================================================
    candidate_4: {
      ...
      immediateAftermath: {
        timeframe: '6 เดือนต่อมา',
        outcome: 'กันจัดการกับการลดถอยลงอย่างมีประสิทธิภาพ สิ่งต่างๆ ไม่แย่ลง แต่ก็ไม่ดีขึ้น ผู้คนยอมรับว่า "นี่คือความเป็นจริง" และหวังว่าจะหายไป ความหวังในเมืองตายลง',
      ...
      hiddenTruths: {
        chosenCandidateSecret: 'กันรู้ถึงโอกาสทางเศรษฐกิจที่อาจจะช่วยกู้สถานการณ์ได้ แต่เขาไม่เคยพูดถึงเพราะเชื่อว่ามันจะล้มเหลว ความเชื่อของเขากลายเป็นนัยสำคัญของความจริง',
        otherCandidateSecrets: [
          {
            candidateId: 'candidate_1',
            secret: 'ป่ามีแผนการลงทุนที่จะสร้างงาน แต่กันปฏิเสธิที่จะพิจารณามัน คุณเลือกที่จะเชื่อความหมดหวังของกัน',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_2',
            secret: 'แบมมีข้อมูลที่แสดงว่าการลงทุนในโครงสร้างพื้นฐานจะช่วยเศรษฐกิจ แต่กันมองข้ามไป',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_3',
            secret: 'ขนุนเสนอโปรแกรมสร้างกำลังใจชุมชน แต่กันบอกว่า "ความหวังเป็นสิ่งอันตราย" และคุณเชื่อเขา',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_5',
            secret: 'ทามพยายามบอกว่ามีทางออก แต่กันหันเหเรื่องไปด้วยความหมดหวัง และคุณก็ทำเช่นเดียวกัน',
            makesPlayerRethink: true,
          },
        ],
    ...
    // ========================================================================
    // CANDIDATE 5: ทาม - Radical Outsider
    // ========================================================================
    candidate_5: {
      ...
      immediateAftermath: {
        timeframe: '6 เดือนต่อมา',
        outcome: 'ทามทำลายระบบที่เน่าสะอมนอย่างรวดเร็ว แต่ไม่มีอะไรมาแทนที่ สถาบันพังทลาย บริการสาธารณะหยุดชะงัก และเกิดช่องว่างอำนาจที่กลุ่มต่างๆ พยายามจะเติมเต็ม ความโกลาหลเริ่มต้น',
      ...
      hiddenTruths: {
        chosenCandidateSecret: 'ทามไม่มีแผนการสร้างใหม่ที่แท้จริง เขาขับเคลื่อนด้วยความโกรธจากการที่ถูกระบบทอดทิ้ง ไม่ใช่เพราะหลักการ เขาเคยเป็นส่วนหนึ่งของระบบจนกถูกไล่ออกเพราะยุบตรวจ',
        otherCandidateSecrets: [
          {
            candidateId: 'candidate_1',
            secret: 'ป่าพยายามเตือนว่า "การทำลายง่ายกว่าการสร้าง" แต่คุณเลือกที่จะเชื่อความโกรธของทาม',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_2',
            secret: 'แบมคำนวณว่าการทำลายระบบจะทำให้เศรษฐกิจลดลง 80% แต่คุณเพิกเฉยต่อความจริงทางตัวเลข',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_3',
            secret: 'ขนุนรู้ว่าทามเคยทุจริต แต่คุณไม่ฟังเธอเพราะดูเหมือนเธอปกป้องระบบ',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_4',
            secret: 'กันบอกว่า "ความโกรธไม่ใช่แผนการ" แต่คุณมองว่าเขาแค่ขี้กลัว',
            makesPlayerRethink: true,
          },
        ],
  ...
  const alternativePaths = otherCandidates.map((candidate) => {
    const alternatives: Record<string, string> = {
      candidate_1: 'หากคุณเลือกป่า เขาจะสร้างความเปลี่ยนแปลงที่น่าประทับใจแต่ขาดแผนงาน ความโกลาหลจะเกิดขึ้นแต่ความหวังก็ยังมี',
      candidate_2: 'หากคุณเลือกแบม เขาจะทำให้ทุกอย่างมีประสิทธิภาพ แต่คนจะกลายเป็นตัวเลข ความเย็นชาจะแพร่กระจายไปทั่วเมือง',
      candidate_3: 'หากคุณเลือกขนุน เธอจะปกป้องทุกคน แต่เสรีภาพของคุณจะค่อยๆ หายไป ความปลอดภัยมีราคาที่คุณไม่เคยคิด',
      candidate_4: 'หากคุณเลือกกัน เขาจะควบคุมการลดถอยลง แต่ไม่มีอะไรดีขึ้น ความหวังจะตายไป และเมืองจะเริ่มเบียดเบียน',
      candidate_5: 'หากคุณเลือกทาม เขาจะเผาทำลายระบบที่เน่าสะอมน แต่สิ่งที่เกิดขึ้นต่อจากนั้นจะแย่กว่าเดิม ความโกลาหลจะปกคลุมทั้งเมือง',
    }
