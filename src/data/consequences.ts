...
export function generateConsequences(
  ...
  const consequenceSets: Record<string, Omit<ConsequenceData, 'alternativePaths'>> = {
    // ========================================================================
    // CANDIDATE 1: ดร. ธีรภัทร์ วีรวัฒน์ - Charismatic Reformer
    // ========================================================================
    candidate_1: {
      ...
      immediateAftermath: {
        ...
        outcome: 'ดร. ธีรภัทร์เปลี่ยนโครงสร้างเมืองอย่างรวดเร็ว ทำลายระบบเก่า แต่การเปลี่ยนแปลงที่ไม่มีการวางแผนส่งผลให้เกิดความโกลาหล ผู้คนสูญเสียสิทธิ์ที่พวกเขาเคยมี ในขณะที่ระบบใหม่ยังไม่พร้อมทำงาน',
      ...
      hiddenTruths: {
        chosenCandidateSecret: 'ดร. ธีรภัทร์ไม่เคยมีแผนงานที่แม่นยำ เขาแค่อยากมีอำนาจ หลังจากได้รับตำแหน่ง เขาใช้เวลาส่วนใหญ่ไปกับการวางแผนสร้างรูปปั้นของตัวเอง ไม่ใช่การแก้ปัญหาของเมือง',
        otherCandidateSecrets: [
          {
            candidateId: 'candidate_2',
            secret: 'ผศ.ดร. ประดิษฐ์คาดการณ์ปัญหานี้ไว้แล้ว และมีแผนสำรองที่จะลดความเสียหาย เขาไม่ได้พูดถึงเพราะไม่อยากดูเหมือนคนข่มอำนาจคนอื่น',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_3',
            secret: 'ดร. กนกวรรณรู้ว่าดร. ธีรภัทร์ไม่ใส่ใจคนที่ถูกทอดทิ้ง เธอมีระบบสวัสดิการสำหรับผู้ได้รับผลกระทบ แต่ไม่มีใครถามเธอถึงมัน',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_4',
            secret: 'สมศักดิ์พยายามเตือนถึง "ผู้นำที่มีเสน่ห์แต่ไม่มีความสามารถ" แต่คุณอาจมองข้ามเพราะดูหมิ่นทัศนคิของเขา',
            makesPlayerRethink: false,
          },
          {
            candidateId: 'candidate_5',
            secret: 'วิชัยพูดถึง "การทุจริตที่ซ่อนอยู่ของดร. ธีรภัทร์" แต่ดร. ธีรภัทร์หันเหเรื่องไป และคุณก็เชื่อเขา',
            makesPlayerRethink: true,
          },
        ],
      ...
      longTermConsequences: {
        ...
        badOutcomes: [
          ...
          'รูปปั้นดร. ธีรภัทร์เสร็จสมบูรณ์ แต่เมืองยังไม่',
        ],
    ...
    // ========================================================================
    // CANDIDATE 2: ผศ.ดร. ประดิษฐ์ นิรันดร์ - Pragmatic Technocrat
    // ========================================================================
    candidate_2: {
      ...
      immediateAftermath: {
        timeframe: '6 เดือนต่อมา',
        outcome: 'ผศ.ดร. ประดิษฐ์นำทางด้วยข้อมูลอย่างเคร่งครัด ตัวชี้วัดทางเศรษฐกิจดีขึ้น แต่คนถูกจัดเป็นตัวเลข ผู้ที่มีประสิทธิภาพน้อยกว่าถูก "ปรับปรุงออก" และไม่มีใครถามถึงต้นทุนทางมนุษย์',
      ...
      hiddenTruths: {
        chosenCandidateSecret: 'ผศ.ดร. ประดิษฐ์มีสเปรดชีตลับที่จัดอันดับประชากรตาม "คุณค่าทางเศรษฐกิจ" เธอรู้ว่าใครจะถูกทอดทิ้งและทำไปอย่างนั้นด้วยความเย็นชา',
        otherCandidateSecrets: [
          {
            candidateId: 'candidate_1',
            secret: 'ดร. ธีรภัทร์พยายามเตือนว่า "มนุษย์ไม่ใช่ตัวเลข" แต่คุณมองข้ามไปเพราะคิดว่าเขาแค่อิจฉาบุคลิกของผศ.ดร. ประดิษฐ์',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_3',
            secret: 'ดร. กนกวรรณต่อสู้กับผศ.ดร. ประดิษฐ์เรื่อง "สิทธิมนุษยชนขั้นพื้นฐาน" เธอมีระบบที่จะช่วยผู้ที่ถูกทอดทิ้ง แต่ถูกปฏิเสธ',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_4',
            secret: 'สมศักดิ์บอกว่า "ข้อมูลไม่เคยบอกเรื่องศีลธรรม" และเขาถูกต้องไปมากกว่าที่คุณคิด',
            makesPlayerRethink: false,
          },
          {
            candidateId: 'candidate_5',
            secret: 'วิชัยค้นพบเอกสารที่แสดงว่าสเปรดชีตของผศ.ดร. ประดิษฐ์มีอคติทางชนชั้น แต่ไม่มีใครฟังเขา',
            makesPlayerRethink: true,
          },
        ],
    ...
    // ========================================================================
    // CANDIDATE 3: ดร. กนกวรรณ สิริมงคล - Healer/Protector
    // ========================================================================
    candidate_3: {
      ...
      immediateAftermath: {
        timeframe: '6 เดือนต่อมา',
        outcome: 'ดร. กนกวรรณสร้างระบบการปกป้องที่ดูเหมือนเป็นห่วงใย แต่เริ่มจำกัดเสรีภาพ "เพื่อความปลอดภัย" ผู้คนถูกปกป้องแต่ถูกควบคุม ไม่อนุญาตให้ตัดสินใจเอง "เพื่อป้องกันความผิดพลาด"',
        expectedOutcome: 'ความปลอดภัยและการดูแลที่เธอสัญญาไว้',
        unexpectedOutcome: 'การสูญเสียเสรีภาพทีละน้อยๆ จนกระทั่งไม่มีใครสังเกตุ',
      },

      hiddenTruths: {
        chosenCandidateSecret: 'ดร. กนกวรรณไม่เคยไว้ใจคนจริงๆ เธอเชื่อว่าผู้คนต้องถูกควบคุมเพื่อปกป้องตัวเอง เธอร่าง "การกักขังเพื่อการปกป้อง" ที่จะอนุญาตให้เธอกักขังคนได้โดยไม่ต้องผ่านกระบวนการยุติธรรม',
        otherCandidateSecrets: [
          {
            candidateId: 'candidate_1',
            secret: 'ดร. ธีรภัทร์พยายามเตือนว่า "การปกป้องที่เกินไปนำไปสู่การครอบงำ" แต่คุณอาจมองว่าเขาแค่อิจฉาอำนาจของเธอ',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_2',
            secret: 'ผศ.ดร. ประดิษฐ์คำนวณว่านโยบายของดร. กนกวรรณจะทำให้เศรษฐกิจชะลอตัวลง แต่คุณเลือกที่จะเชื่อถือความรู้สึกมากกว่าข้อมูล',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_4',
            secret: 'สมศักดิ์บอกว่า "ความปลอดภัยที่มาพร้อมกับการควบคุมยังคงเป็นการควบคุม" แต่ดูเหมือนคุณไม่ได้ยิน',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_5',
            secret: 'วิชัยรู้ว่าดร. กนกวรรณเคยใช้อำนาจอย่างผิดทางในอดีต แต่ไม่มีใครเชื่อเขาเพราะดูเหมือนคนหวาดระแหง',
            makesPlayerRethink: false,
          },
        ],
    ...
    // ========================================================================
    // CANDIDATE 4: สมศักดิ์ 'สั้น' ทองมี - Cynical Realist
    // ========================================================================
    candidate_4: {
      ...
      immediateAftermath: {
        timeframe: '6 เดือนต่อมา',
        outcome: 'สมศักดิ์จัดการกับการลดถอยลงอย่างมีประสิทธิภาพ สิ่งต่างๆ ไม่แย่ลง แต่ก็ไม่ดีขึ้น ผู้คนยอมรับว่า "นี่คือความเป็นจริง" และหวังว่าจะหายไป ความหวังในเมืองตายลง',
      ...
      hiddenTruths: {
        chosenCandidateSecret: 'สมศักดิ์รู้ถึงโอกาสทางเศรษฐกิจที่อาจจะช่วยกู้สถานการณ์ได้ แต่เขาไม่เคยพูดถึงเพราะเชื่อว่ามันจะล้มเหลว ความเชื่อของเขากลายเป็นนัยสำคัญของความจริง',
        otherCandidateSecrets: [
          {
            candidateId: 'candidate_1',
            secret: 'ดร. ธีรภัทร์มีแผนการลงทุนที่จะสร้างงาน แต่สมศักดิ์ปฏิเสธิที่จะพิจารณามัน คุณเลือกที่จะเชื่อความหมดหวังของสมศักดิ์',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_2',
            secret: 'ผศ.ดร. ประดิษฐ์มีข้อมูลที่แสดงว่าการลงทุนในโครงสร้างพื้นฐานจะช่วยเศรษฐกิจ แต่สมศักดิ์มองข้ามไป',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_3',
            secret: 'ดร. กนกวรรณเสนอโปรแกรมสร้างกำลังใจชุมชน แต่สมศักดิ์บอกว่า "ความหวังเป็นสิ่งอันตราย" และคุณเชื่อเขา',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_5',
            secret: 'วิชัยพยายามบอกว่ามีทางออก แต่สมศักดิ์หันเหเรื่องไปด้วยความหมดหวัง และคุณก็ทำเช่นเดียวกัน',
            makesPlayerRethink: true,
          },
        ],
    ...
    // ========================================================================
    // CANDIDATE 5: วิชัย เสรีชัย - Radical Outsider
    // ========================================================================
    candidate_5: {
      ...
      hiddenTruths: {
        ...
        otherCandidateSecrets: [
          {
            candidateId: 'candidate_1',
            secret: 'ดร. ธีรภัทร์พยายามเตือนว่า "การทำลายง่ายกว่าการสร้าง" แต่คุณเลือกที่จะเชื่อความโกรธของวิชัย',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_2',
            secret: 'ผศ.ดร. ประดิษฐ์คำนวณว่าการทำลายระบบจะทำให้เศรษฐกิจลดลง 80% แต่คุณเพิกเฉยต่อความจริงทางตัวเลข',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_3',
            secret: 'ดร. กนกวรรณรู้ว่าวิชัยเคยทุจริต แต่คุณไม่ฟังเธอเพราะดูเหมือนเธอปกป้องระบบ',
            makesPlayerRethink: true,
          },
          {
            candidateId: 'candidate_4',
            secret: 'สมศักดิ์บอกว่า "ความโกรธไม่ใช่แผนการ" แต่คุณมองว่าเขาแค่ขี้กลัว',
            makesPlayerRethink: true,
          },
        ],
  ...
  const alternativePaths = otherCandidates.map((candidate) => {
    const alternatives: Record<string, string> = {
      candidate_1: 'หากคุณเลือก ดร. ธีรภัทร์ เขาจะสร้างความเปลี่ยนแปลงที่น่าประทับใจแต่ขาดแผนงาน ความโกลาหลจะเกิดขึ้นแต่ความหวังก็ยังมี',
      candidate_2: 'หากคุณเลือก ผศ.ดร. ประดิษฐ์ เขาจะทำให้ทุกอย่างมีประสิทธิภาพ แต่คนจะกลายเป็นตัวเลข ความเย็นชาจะแพร่กระจายไปทั่วเมือง',
      candidate_3: 'หากคุณเลือก ดร. กนกวรรณ เธอจะปกป้องทุกคน แต่เสรีภาพของคุณจะค่อยๆ หายไป ความปลอดภัยมีราคาที่คุณไม่เคยคิด',
      candidate_4: 'หากคุณเลือก สมศักดิ์ เขาจะควบคุมการลดถอยลง แต่ไม่มีอะไรดีขึ้น ความหวังจะตายไป และเมืองจะเริ่มเบียดเบียน',
      candidate_5: 'หากคุณเลือก วิชัย เขาจะเผาทำลายระบบที่เน่าสะอมน แต่สิ่งที่เกิดขึ้นต่อจากนั้นจะแย่กว่าเดิม ความโกลาหลจะปกคลุมทั้งเมือง',
    }
