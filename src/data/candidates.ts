...
export const candidate1: Candidate = {
  ...
  // ------------------------------------------------------------------
  personality:
    'มั่นใจ สร้างแรงบันดาลใจ และมีวิสัยทัศน์ ป่าพูดด้วยความมั่นใจและนำเสนอทางออกที่กล้าหาญสำหรับปัญหาที่ซับซ้อน เขาเชื่อในความก้าวหน้าและไม่กลัวที่จะท้าทายคิดเก่า เขาอาจดูเหมือนมีความมั่นใจเล็กน้อย โดยมองความกังวลเป็น "การคิดแคบ"',
  speakingStyle:
...
export const candidate2: Candidate = {
  ...
  // ------------------------------------------------------------------
  personality:
    'ฉลาด วิเคราะห์ และแยกตัวออกจากอารมณ์ แบมพูดด้วยข้อเท็จจริงและตัวเลข เขาว่าทุกปัญหามีคำตอบที่เหมาะที่สุดหากลบอารมณ์ออกจากสมการ อาจดูเย็นชา หรือปฏิเสธิต่ความกังวลทางอารมณ์',
  speakingStyle:
...
export const candidate4: Candidate = {
  ...
  // ------------------------------------------------------------------
  personality:
    'มองโลกแฝงความหวัง เบื่อหน่าย และซื่อสัตย์ในการบอกความจริง กันไม่ได้แสดงว่ามีคำตอบทั้งหมด เขายอมรับว่าเมืองกำลังเสื่อมลงและตัวเลือกทั้งหมดแย่ มีดีหรอย เขาวางตัวเองเป็นคนเดียวที่จะบอกความจริงที่เจียมจะฟัง',
  speakingStyle:
...
export const candidate5: Candidate = {
  ...
  // ------------------------------------------------------------------
  personality:
    'กระตือรุนแรง โกรธ และต่อต้านระบบ ทามวางตัวเองเป็นคนภายนอกที่มองเห็นสิ่งที่คนอื่นมองข้าม เขาดุกรณและชอง้ำจนที่จะเปิดโปงงการและความเสแม็ธ อาจดูเหมือะคนหวา่ขี้หรือไม่มั่นคง',
  speakingStyle:
